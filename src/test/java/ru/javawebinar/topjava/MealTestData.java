...
public class MealTestData {
    ...
    public static final List<UserMeal> USER_MEALS_TEST_DELETED = Arrays.asList(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2);
    public static final List<UserMealWithExceed> USER_MEALS_BETWEEN_TEST = UserMealsUtil.getFilteredWithExceeded(
            Arrays.asList(MEAL2, MEAL3, MEAL4),
            LocalTime.MIN,
            LocalTime.MAX,
